...
<template>
    ...
    <div class="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-[#0a0a0a]">
        <header class="mb-6 w-full max-w-[335px] text-sm not-has-[nav]:hidden lg:max-w-4xl">
            <nav class="flex items-center justify-start gap-2">
        ...
        <div class="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
            <main class="flex w-full max-w-[335px] flex-col-reverse overflow-hidden rounded-lg lg:max-w-4xl lg:flex-row">
                ...
                >
                    <h1 class="mb-1 font-medium">LULU WORKSHOP</h1>
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                        We understand that your vehicles are not merely modes of transportation,they are expressions of your taste and style 
                        Our discreet and exclusive services caters to your privacy and ensures that your prized possession is handled with the unmost care and confidentiality
                        Trust us to maintain the elegance and allure of your automobile while keeping our work behind closed doors <br />We suggest starting with the following.
                    </p>
                        ...
                        >
                            ...
                            <span>
                                ...
                                <a
                                    ...
                                    class="ml-1 inline-flex items-center space-x-1 font-medium text-[#f53003] underline underline-offset-4 dark:text-[#FF4433]"
                                >
                                    <span>Full Vehicle Restoration</span>
                                    <svg
                                        width="{10}"
                                        height="{11}"
                                        viewBox="0 0 10 11"
